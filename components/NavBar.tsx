...
const NavBar = () => {
  ...
  return (
    <div className="z-50 fixed justify-center w-full text-white font-bold">
      <div className="border border-white/20 mt-8 backdrop-blur-3xl rounded-3xl hidden md:flex items-center justify-center p-2 max-w-100 mx-auto">
      ...
      <div
        className={`fixed left-0 top-0 w-full h-full bg-black/90 transform transition duration-300 ${nav ? "translate-x-0" : "-translate-x-full"}`}
      >
